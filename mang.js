...
const configuration = new Configuration({
    apiKey: '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',
});
    ...
    sock.ev.on("messages.upsert", async ({ messages, type }) => {
        ...
        if (type === "notify" && !messages[0].key.fromMe) {
            try {
                ...
                const isMessageMentionBot = incomingMessages.includes("@6289658407880");
